 ...
 * @author Benji
 */
public class menuVentasTrabajador extends javax.swing.JPanel {

    public menuVentasTrabajador() {
        initComponents();
...
//        cerrar.setVisible(false);
        frmVenta_TRABAJADOR abrir = new frmVenta_TRABAJADOR();
        abrir.setVisible(true);
        JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(menuVentasTrabajador.this);
        if (frame != null) {
