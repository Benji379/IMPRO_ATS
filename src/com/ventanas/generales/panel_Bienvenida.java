...
import com.formato.procesos.HoraActual;
 ...
 * @author Benji
 */
public final class panel_Bienvenida extends javax.swing.JPanel {
    ...
    public void ActualizarHora() {
        ...
        Timer tiempoPeque = new Timer(100, new Clima());
        tiempo.start();
        tiempoPeque.start();
    }
    ...
    private void perfilUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_perfilUsuarioMouseClicked
        if (evt.getClickCount() == 2) {
            panelCarnet abrir = new panelCarnet();
