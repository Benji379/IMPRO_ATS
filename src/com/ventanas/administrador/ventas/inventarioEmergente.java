...
public final class inventarioEmergente extends javax.swing.JFrame {

    CrudJTable crud = new CrudJTable();

    public inventarioEmergente() {
        initComponents();
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        frmVenta.txtCodigo.setText(codigoProducto);
        frmVenta.txtCodigo.requestFocus();
        frmVenta.consultarPrecioProduc();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inventarioEmergente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new inventarioEmergente().setVisible(true);
        });
    }
