...
import com.chat.animation.AnimationFloatingButton;
import com.chat.animation.AnimationScroll;
import com.chat.model.ModelMessage;
import com.chat.swing.Button;
import com.chat.swing.RoundPanel;
import com.chat.swing.TextField;
import com.chat.swing.scroll.ScrollBar;
...
public class ChatArea extends JPanel {
    ...
    private JPanel createBottom() {
        ...
        textMessage.setHint("Ingrese su mesanje..");
    ...
    public void addChatBot(ModelMessage message, ChatBot.BoxType type) {
        int values = scrollBody.getVerticalScrollBar().getValue();
        if (type == ChatBot.BoxType.LEFT) {
            body.add(new ChatBot(type, message), "width ::80%");
        } else {
            body.add(new ChatBot(type, message), "al right,width ::80%");
        }
        SwingUtilities.invokeLater(() -> {
            body.revalidate();
            scrollBody.getVerticalScrollBar().setValue(values);
