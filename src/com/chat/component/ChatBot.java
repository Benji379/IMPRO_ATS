...
import com.chat.swing.AutoWrapText;
import com.chat.swing.ImageAvatar;
...
public class ChatBot extends JComponent {

    private final BoxType boxType;
    private final ModelMessage message;

    public ChatBot(BoxType boxType, ModelMessage message) {
    ...
    private void initBot() {
        ...
        k.mostrarTextoAnimado(text, message.getMessage(), 50);
        //============================================================
    }
